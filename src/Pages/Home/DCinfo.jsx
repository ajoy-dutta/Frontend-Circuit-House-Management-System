  ...
  return (
    <div className="bg-[#f5efe7]">
      <div className="py-10 px-4 md:px-10">
        <div className="grid sm:grid-rows-1 md:grid-cols-2 py-4 place-items-start">
          {/* Left Section */}
          <div className="my-5 md:my-0 md:border-r-[1px] md:h-[280px] border-[#d8c4b6]">
            <div className="px-5 space-y-3 font-serif">
              ...
              <p className="text-justify">
                ...
                presents a blend of tradition and modernity. Maintained by the
                District Administration, Circuit House serves as a haven for
                dignitaries and visitors, offering both comfort and a connection
                to history. Its neatly manicured gardens and endless green lawn
                breathe life into its surroundings. Over the years, Jashore
                Circuit House has witnessed the convergence of tradition and
                progress, standing as a symbol of Jashore’s enduring heritage
          ...
          <div>
            <div className="lg:w-[550px] mx-auto">
              <p className="font-bold text-center text-xl font-serif">
                Deputy Commissioner and Learned District Magistrate, Jashore
              </p>
            </div>
            <div className="flex flex-col lg:flex-row items-center font-serif justify-center place-items-center">
              <div className="block lg:hidden w-1/3 p-2 border border-[#d8c4b6] rounded-full me-3">
