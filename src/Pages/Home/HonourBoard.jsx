...
const HonourBoard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (addedItem.designation_type === "DC") {
        SetDCHonourlist((prev) => [...prev, addedItem]);
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
    <div className="bg-white p-4 rounded-lg w-11/12 sm:w-4/5 md:w-2/3 lg:w-1/2 xl:w-1/3 max-w-2xl">
      ...
      {/* Display Honour Boards */}
      <div className="p-8 bg-teal-50 mb-6 mt-10 ">
        <h2 className="text-center text-xl font-bold mb-4 py-2">ডেপুটি কালেক্টর</h2>
