      ...
      <div className="p-8 bg-teal-50 mb-6 mt-10 ">
        ...
        <div className=" space-y-0">
          {DChonourlist.map((item, index) => (
            <div
              key={item.id}
              className="shadow-lg rounded-lg border border-1 mb-5 border-gray  p-4"
            >
              {/* Left: Number */}
              <div className="">
                ...
                <div className="grid lg:grid-cols-3 gap-3">
                  <div className="block md:hidden items-center justify-center w-3/4 border-gray-300">
                    <img
                      src={item.photo}
                      alt={item.name}
                  ...
                  <div className="col-span-2 border ">
                    <div className="w-auto">
                      ...
                      <p className="text-sm text-gray-600 px-2  border border-1 border-gray">
                        <strong>প্রস্থানের তারিখঃ</strong>{" "}
                        {item.ending_date ? item.ending_date : "চলমান"}
                      </p>
                      <p className="text-sm text-gray-600 px-2  border border-1 border-gray">
                  ...
                  {/* Left: Image */}
                  <div className="hidden lg:block w-3/4 border-gray-300">
                    <img
                      src={item.photo}
                      alt={item.name}
                      className="w-28 h-28 object-cover rounded-full border-2 border-gray-300"
      ...
      <div className="p-8 bg-teal-50 mb-6 mt-10 ">
        ...
        <div className="space-y-0">
          {NDChonourlist.map((item, index) => (
            <div
              key={item.id}
              className=" shadow-lg rounded-lg p-4 border border-1 border-gray"
            >
              {/* Left: Number */}      
              <div className="">
                <div className="w-1/8 text-center text-sm font-semibold  text-gray-800 p-3">
