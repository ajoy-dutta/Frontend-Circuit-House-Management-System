...
const Details = () => {
  ...
  return (<div className="flex justify-center items-center min-h-screen bg-gray-100 flex-col">
      ...
      <div className="overflow-x-auto shadow-md rounded-lg border border-gray-200">
        <table className="w-full text-sm text-gray-700 border-collapse">
          <thead className="bg-teal-600 text-white">
            <tr>
              <th className="px-6 py-3 text-center font-semibold">SL No.</th>
              <th className="px-6 py-3 text-center font-semibold">Guest Type</th>
              <th className="px-6 py-3 text-center font-semibold">1-3 days</th>
              <th className="px-6 py-3 text-center font-semibold">4-7 days</th>
              <th className="px-6 py-3 text-center font-semibold">8 days or up</th>
            </tr>
          </thead>
          <tbody>
            {grouped.map(([guestType, prices], index) => (
              ...
              >
                ...
                <td className="px-6 py-3 text-center">{guestType}</td>
                {prices.price_per_day ? (
                  <td
                    className="px-6 py-3 text-center font-semibold text-teal-700"
                    colSpan={3}
                  >
                    {prices.price_per_day}
                  </td>
                    ...
                    <>
                      <td className="px-6 py-3 text-center">{prices["1-3"]}</td>
                      <td className="px-6 py-3 text-center">{prices["4-7"]}</td>
                      <td className="px-6 py-3 text-center">{prices["7+"]}</td>
                    </>
                  )}
              </tr>
            ))}
