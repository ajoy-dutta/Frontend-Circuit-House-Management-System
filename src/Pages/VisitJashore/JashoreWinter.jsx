    ...
    <div className="bg-gradient-to-br from-white to-blue-50 space-y-4 text-gray-800 font-sans">
      ...
      >
        ...
        >
          ...
          <p className="mb-4">
            ...
            hospitality await you. Jashore, often called the “Land of Flowers,”
            offers a travel experience like no other—authentic, soulful, and
            deeply cultural.
          </p>
          <p className="mb-4">
            This thoughtfully crafted tour invites you to trace the footsteps of
            Michael Madhusudan Dutt, Bengal’s pioneering poet, and explore the
        ...
        >
          ...
          <p className="mb-4">
            ...
            Early mornings offer fresh date juice from palm trees—either served
      ...
      <section className="py-10 border rounded-lg px-4 max-w-5xl mx-auto">
        ...
        <ul className="list-disc ml-6 space-y-2">
          <li>
            🌺 Seasonal Festivals: Jhikargacha Flower Festival, Chougacha Gur
            Festival, Modhumela
          </li>
          <li>🏢 Colonial Collectorate & Municipal Park Tour</li>
          <li>
            📍 Heritage Trail: Bharat Rajar Deol, Ram Krishna Ashram, Imam Bara,
            Chachra Temple, Mirzanagar Hammamkhana
          </li>
          <li>🛣️ Jessore Road tour inspired by Allen Ginsberg</li>
          <li>🌺 Visit to Benapol Port</li>
          <li>🌳 Baor Excursions & Stitch Showcase</li>
          <li>🥮 Daily Bengali meals & Pitha Trail</li>
        </ul>
      </section>
      ...
      <section className="py-10 px-4 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border p-4 rounded shadow">
            ...
            <p>Comfortable 4-seater — best for solo/couples</p>
          </div>
          <div className="border p-4 rounded shadow">
      ...
      <section className="py-10 px-4 max-w-5xl mx-auto bg-indigo-100 rounded text-indigo-800">
        ...
        <p>
          Approximately USD 525 for 2 persons — final pricing varies by plan.
